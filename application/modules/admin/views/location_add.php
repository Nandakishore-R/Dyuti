...
<div class="static-content">
	<div class="page-content">
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo $this->config->item('admin_url')."programs"; ?>">Venue</a></li>
									...
									<div class="row">
										<div class="col-xs-6">
											<div class="form-group">
												<label for="focusinput" class="control-label">Venue</label>
												<input class="form-control" type="hidden" name="id" value="<?php echo $id;?>">
												<input type="text" name="location" class="form-control validate[required,minSize[2],maxSize[100]]" value="<?php echo $location;?>">
											</div>
										</div>
